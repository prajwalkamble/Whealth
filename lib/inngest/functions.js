        ...
        if (
          ...
          await sendEmail({
            ...
            react: EmailTemplate({
              ...
              data: {
                percentageUsed,
                budgetAmount: parseInt(budget.amount).toFixed(2),
        ...
        return await db.transaction.findMany({
          where: {
            ...
            OR: [
              ...
              { nextRecurringDate: { lte: new Date() } }, // Next recurring date is in the past
            ],
          },
        });
      }
  ...
  async ({ event, step }) => {
    ...
    await step.run("process-transaction", async () => {
      ...
      await db.$transaction(async (tx) => {
        ...
        // Update last process date and next recurring date
  ...
  const prompt = `
    ...
    try {
      ...
      return [
        ...
        "Track your recurring expenses to identify potential savings to optimize your spending.",
      ];
    }
}
